        ...
        <div class="signup__container">
            <div class="container__child signup__thumbnail">
                <div class="thumbnail__logo">
                    ...
                    <h1 class="logo__text">ABC</h1>
                </div>
                <div class="thumbnail__content text-center">
                    <h1 class="heading--primary">Welcome to MYADMIN.</h1>
                    <h2 class="heading--secondary">Are you ready to Register With Company</h2>
                </div>
            ...
            <div class="container__child signup__form">
                <form method="POST"  action = "<?php $_PHP_SELF ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="mobile" id="" placeholder="123" required />
                    </div>
                    <div class="form-group">
